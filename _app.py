...
#4.1
#
def encoding(df, column="all_nominal", all_nominal=["rbc", "pc", "pcc", "ba", "htn", "dm", "cad", "appet", "pe", "ane", "class"]):
    """
    paramters:
    ----------
...
#4.2
#
def missing_handling(df, column="all", method="mean", all_col=["age", "bp", "sg", "al", "su", "bgr", "bu", "sc", "sod", "pot", "hemo", "pcv", "wbcc", "rbcc", "rbc", "pc", "pcc", "ba", "htn", "dm", "cad", "appet", "pe", "ane", "class"]):
    """
    paramters:
    ----------
    df: input tipe dataframe
...
def normalizing(df, column="all", f_range=(0, 1), all_col=["age", "bp", "sg", "al", "su", "bgr", "bu", "sc", "sod", "pot", "hemo", "pcv", "wbcc", "rbcc", "rbc", "pc", "pcc", "ba", "htn", "dm", "cad", "appet", "pe", "ane"]):
    """
    paramters:
    ----------
    df: input tipe dataframe
